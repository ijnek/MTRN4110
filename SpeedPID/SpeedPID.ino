...
//int M_left_A =4; //The enabling of L298PDC motor driver board connection to the digital interface port 4
//int M_left_B =5;
const byte encoder0pinA = 2;//A pin -> the interrupt pin 0
const byte encoder0pinB = 11;//B pin -> the digital pin 3
int E_left =9; //The enabling of L298PDC motor driver board connection to the digital interface port 5
int M_left_A =6; //The enabling of L298PDC motor driver board connection to the digital interface port 4
int M_left_B =7;
...
void setup()
{
  Serial.begin(9600);//Initialize the serial port
   pinMode(M_left_A, OUTPUT);   //L298P Control port settings DC motor driver board for the output mode
